...
func getCourses(dr selenium.WebDriver, student *Student) {
	...
	exYears, _ := FindElementsWD(dr, selenium.ByXPATH, "L/html/body/div/div/div[4]/div[2]/div/div[2]/ul//a[@href='javascript:void(0)']")
